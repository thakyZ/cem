...
import net.dorianpb.cem.forge.external.models.CemPhantomModel;
...
public class CemPhantomRenderer extends PhantomEntityRenderer implements CemRenderer {
  private final CemModelRegistry registry;

  public CemPhantomRenderer(EntityRendererFactory.Context context) {
    super(context);
    this.registry = CemRegistryManager.getRegistry(getType());
    try {
      this.model = new CemPhantomModel(registry);
