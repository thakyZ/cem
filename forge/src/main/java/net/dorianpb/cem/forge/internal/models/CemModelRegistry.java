package net.dorianpb.cem.forge.internal.models;

import net.dorianpb.cem.forge.internal.api.CemModel.VanillaReferenceModelFactory;
import net.dorianpb.cem.forge.internal.config.CemOptions;
import net.dorianpb.cem.forge.internal.models.CemModelEntry.CemModelPart;
import net.dorianpb.cem.forge.internal.models.CemModelEntry.TransparentCemModelPart;
import net.dorianpb.cem.forge.internal.util.CemStringParser;
import net.dorianpb.cem.forge.internal.util.CemStringParser.ParsedExpression;
import net.dorianpb.cem.common.internal.file.JemFile;
import net.dorianpb.cem.common.internal.file.JemFile.JemModel;
...
public class CemModelRegistry {
	...
	public CemModelPart prepRootPart(CemRootPartParams params) {
		...
		if (CemOptions.USE_TRANSPARENT_PARTS.get()) {
